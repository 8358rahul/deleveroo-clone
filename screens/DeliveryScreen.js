  ...
  return (
    <View className="bg-[#00CCBB] flex-1 ">
      <SafeAreaView className="z-50 mt-5">
        ...
        <View className="bg-white mx-5 rounded-md p-4 z-50 shadow-md">
          ...
          <Text className="mt-3 text-gray-500">
            Your order as <Text className="text-black font-bold underline">{restaurant.title}</Text> is being prepared
          </Text>
        </View>
      </SafeAreaView>
      <MapView
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-20">
        ...
        className="w-15 h-15 bg-gray-300 p-4 rounded-full ml-5"
        />
